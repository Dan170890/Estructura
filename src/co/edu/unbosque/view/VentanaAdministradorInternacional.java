...
public class VentanaAdministradorInternacional extends JPanel {
	...
	public VentanaAdministradorInternacional() {
		setLayout(null);
		...
		btnActualizarSalida.setBounds(605, 365, 140, 165);
		btnActualizarSalida.setBorderPainted(false);
		btnActualizarSalida.setContentAreaFilled(false);
		add(btnActualizarSalida);
		// pos mostrarsalida 605, 365,140, 165
		// pos actualizarsalida 412, 365, 140, 165
		btnMostrarSalida = new JButton("");
		btnMostrarSalida.setBounds(412, 365, 140, 165);
		...
		btnActualizarLlegada.setBounds(598, 170, 140, 165);
		...
		btnMostrarLlegada.setBounds(412, 170, 140, 165);
	...
	public void paintComponent(Graphics g) {
		...
		ImageIcon imagenFondo = new ImageIcon(getClass().getResource("MenuInternacional.png"));
