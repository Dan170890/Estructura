...
public class VentanaCrearSalidaInternacional extends JPanel{
	
	JButton btnVolver, btnGuardar;
	private JTextField txtOrigen, txtSalida;
	private JComboBox<String> jcbAreolinea;
	
	public VentanaCrearSalidaInternacional() {
		setLayout(null);
		...
		txtSalida.setBounds(505, 325, 105, 50);
		add(txtSalida);
